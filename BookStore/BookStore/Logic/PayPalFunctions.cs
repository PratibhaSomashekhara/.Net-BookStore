...
namespace BookStore.Logic
{
    ...
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "pratibhathimmoji-facilitator_api1.gmail.com";
        private string APIPassword = "RQWPGLJH3SD2WEP5";
        private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A.bzp3NYBfogpIpEWJeHJuPbF.Vw";
        ...
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
        {
            ...
            encoder["BRANDNAME"] = "Book Store Sample Application";
            ...
            using (BookStore.Logic.ShoppingCartActions myCartOrders = new BookStore.Logic.ShoppingCartActions())
            {
